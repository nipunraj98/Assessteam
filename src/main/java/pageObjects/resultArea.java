...
public class resultArea {
	...
	By includebutton=By.xpath("//*[@id=\"frmAddResultAreaForPerson\"]/h4/div/span/button");
	By savebutton=By.xpath("//*[@id=\"btnAddPersonResultArea\"]");
	By resultareas=By.xpath("//*[@id=\"divSearch\"]/div[2]/div[1]/div/div[1]/ul/li[2]/a");

	public resultArea(WebDriver driver) {
