		 ...
		 @Test(priority=2)
			...
			public void c_AddPerson() throws IOException, InterruptedException
			 ...
			 Addperson AP= new Addperson(driver);
		 		...
		 		driver.findElement(By.xpath("//*[@id=\"divSearch\"]/div[2]/div/div/div[1]/div[2]/a[4]")).click();
		 		...
		 		Thread.sleep(2000);
		 		driver.findElement(By.xpath("//*[@id=\"foCSVFile\"]")).click();
		 		Thread.sleep(4000);
		 		Reporter.log("Import button is being clicked");
		 		getScreenShot("ImportPage");
		 		Runtime.getRuntime().exec("C:\\Users\\pulse.tester\\Documents\\AssessTeam\\fileupload.exe");
		 		Thread.sleep(3000);
