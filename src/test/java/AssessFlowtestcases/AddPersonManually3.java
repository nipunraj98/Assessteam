...
public class AddPersonManually3 extends base{
	  ...
	  File src=new File("C:\\Users\\pulse.tester\\Documents\\AssessTeam\\TestData.xlsx");
	    ...
	    int loop=1;
		 ...
		 @Test(priority=2)
			...
			public void c_AddPerson_three() throws IOException, InterruptedException
				{
			 FileInputStream fisexcel= new FileInputStream(src);
		 		workbook= new XSSFWorkbook(fisexcel);
		 		sheet=workbook.getSheet("ADDPersonManually_three");
		 		...
		 		String peerEvaluator=formatter.formatCellValue(sheet.getRow(1).getCell(16));
		 		String upwardEvaluator=formatter.formatCellValue(sheet.getRow(1).getCell(17));
			 ...
			 Addperson AP= new Addperson(driver);
				...
				jsePeerGroubTab.executeScript("arguments[0].scrollIntoView();", driver.findElement(By.xpath("//*[@id=\"s2id_autogen2\"]")));
		 		//driver.findElement(By.xpath("//*[@id=\"s2id_autogen2\"]")).click();
		 		Thread.sleep(2000);
		 		driver.findElement(By.xpath("//*[@id=\"s2id_autogen2\"]")).sendKeys(peerEvaluator);
		 		Thread.sleep(2000);
		 		driver.findElement(By.xpath("//span[@class='select2-match']")).click();
		 		Reporter.log("Peer evaluator is being added: " +peerEvaluator);
		 		Thread.sleep(2000);
		 	    driver.findElement(By.xpath("//*[@id=\"s2id_autogen3\"]")).click();
		 	   Thread.sleep(2000);
		 	  driver.findElement(By.xpath("//*[@id=\"s2id_autogen3\"]")).sendKeys(upwardEvaluator);
		 	 Thread.sleep(2000);
		 		driver.findElement(By.xpath("//span[@class='select2-match']")).click();
		 		Reporter.log("Upward evaluator is being added: " +upwardEvaluator);
