...
@Test(priority=3)
		...
		public void d_AddPI() throws IOException, InterruptedException
			{
	            driver.findElement(By.xpath("//a[@id='add_performance']")).click();
				Thread.sleep(2000);
				...
				driver.findElement(By.xpath("//select[@id='ddlEvaluationMethod']")).click();
				Select EvaluationMethod= new Select(driver.findElement(By.xpath("//select[@id='ddlEvaluationMethod']")));
				EvaluationMethod.selectByVisibleText("Selections with scores");
				...
				driver.findElement(By.xpath("//button[@class='btn btn-lg blue margin-bottom-10']")).click();
