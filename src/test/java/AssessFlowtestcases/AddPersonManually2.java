...
public class AddPersonManually2 extends base{
	  ...
	  File src=new File("C:\\Users\\pulse.tester\\Documents\\AssessTeam\\TestData.xlsx");
	    ...
	    int loop=1;
		 ...
		 @Test(priority=2)
			...
			public void c_AddPerson_two() throws IOException, InterruptedException
				{
			 FileInputStream fisexcel= new FileInputStream(src);
		 		workbook= new XSSFWorkbook(fisexcel);
		 		sheet=workbook.getSheet("ADDPersonManually_two");
