...
public class signupsequential extends base {
   ...
   // File srcExcel=new File("C:\\Users\\pulse.tester\\Documents\\AssessTeam\\TestDataExcel.xlsx");
	 ...
	 @Test(priority=0)
		...
		public void a_HomepageNavigation() throws IOException
			...
			//driver.get(prop.getProperty(FullName));
	 ...
	 @Test(priority=1)
		...
		public void b_signUp() throws IOException, InterruptedException
		 ...
		 File srcExcel=new File("C:\\Users\\pulse.tester\\Documents\\AssessTeam\\TestDataExcel.xlsx");
		 		...
		 		FileInputStream fisexcel1= new FileInputStream(srcExcel);
		 		workbook1= new XSSFWorkbook(fisexcel1);
		 		sheet1=workbook1.getSheet("TestData");
		 		String build=formatter.formatCellValue(sheet1.getRow(1).getCell(1));//getting data from excel to append
		 		String CompanyNamewithBuild=CompanyName + build;
		 		System.out.println(CompanyNamewithBuild);
		 		
		 		driver.findElement(By.xpath("//a[@href='https://account.assessteam.com/signup']")).click();
		 		Thread.sleep(2000);
				...
				getScreenShot("signup page");
		 		...
		 		Thread.sleep(2000);
		 		driver.findElement(By.xpath("//html/body/form/div/div/div[3]/div[3]/div/label")).click();
		 		...
		 		driver.findElement(By.xpath("//*[@id=\"txtCompanyName\"]")).sendKeys(CompanyNamewithBuild);
		 		...
		 		int build1= Integer.valueOf(build);
		 		System.out.println(build1);
		 		build1= build1 + 1;
		 		System.out.println(build1);
		 		 String buildString=String.valueOf(build1);
		 		System.out.println(buildString);
		 		
		 		Row row = sheet1.createRow(1);
				 Cell cell1 = row.createCell(1);
				 cell1.setCellValue(buildString);
				 FileOutputStream fos = new FileOutputStream("C:\\Users\\pulse.tester\\Documents\\AssessTeam\\TestDataExcel.xlsx");
				 workbook1.write(fos);
				 fos.close();
				 System.out.println(buildString);
