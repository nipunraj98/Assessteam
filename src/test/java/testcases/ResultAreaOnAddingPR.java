...
public class ResultAreaOnAddingPR extends base{
    ...
    int loop=1;
	 ...
	 @Test(priority=2,dataProvider = "ResultAreaData")
	
		
		public void c_AddPeople(String FirstName, String LastName, String PersonCode, String DOJ, String Email, String ContactNumber, String HourlyPayRate, String Evaluator1, String Evaluator2, String PeerGroup, String Team, String JobTitle, String ResultArea) throws IOException, InterruptedException
			{
				...
				AP.getpeergrouptab().click();
		 		...
		 		//AP.clicksave().click();
		 		AP.clickresultarea().click();
		 		Reporter.log("The setup Result areas button is being clicked");
		 		
		 		Thread.sleep(2000);
		 		getScreenShot("Resultarea Screen");
		 		
		 		AR.getsearchresultarea().click();
		 		AR.getenterSearchresult().click();
		 		AR.getenterSearchresult().sendKeys(ResultArea);
		 		Thread.sleep(2000);
		 		...
		 		driver.findElement(By.xpath("//span[@class='select2-match']")).click();
		 		AR.getincludebutton().click();
		 		AR.getsavebutton().click();
		 		Thread.sleep(2000);
	 ...
	 @DataProvider
	 public static Object[][] ResultAreaData() throws IOException
	 {
	 FileInputStream fileInputStream= new FileInputStream("C:\\Users\\pulse.tester\\Documents\\AssessTeam\\TestData.xlsx"); //Excel sheet file location get mentioned here
	     ...
	     worksheet=workbook.getSheet("ResultArea");// get my sheet from workbook
